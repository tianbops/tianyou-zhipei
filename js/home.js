/* 天友智配One - 首页业务逻辑
 * 第一阶段：图片 -> OCR -> 完整原始文字输入框
 * OCR阶段不解析门店、不比对基准、不排序、不保存订单。
 */
(function(){
  'use strict';
