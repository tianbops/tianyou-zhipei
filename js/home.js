...
window.goToAdmin=async()=>{try{const me=await Auth.getCurrentServerUser();if(me?.adminLevel!=='primary'){toast('当前账号不是主系统管理员，无法打开系统管理','error');return}location.replace('admin.html')}catch(e){toast('非管理员用户，无法打开系统管理','error')}};
