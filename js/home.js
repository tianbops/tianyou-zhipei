...
if(parsedOrders.length){
  ...
  if(mergeCount||correctionCount){
    detailLines.push(`规划完成：现在${uniqueCount}家，原来${rawCount}家，合并${mergeCount}家，更正${correctionCount}家`);
