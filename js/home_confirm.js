...
(function(){
  ...
  async function confirm(){
    ...
    try{
      ...
      if(pending.length){
        window.renderUnifiedStatus?.('error',100,`请先确认 ${pending.length} 家疑似门店`);
